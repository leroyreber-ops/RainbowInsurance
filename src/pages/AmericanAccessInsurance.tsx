...
export default function AmericanAccessInsurance({ navigateTo, openQuoteForm }: PageProps) {
  const carrierSchema = {
    "@context": "https://schema.org",
    "@type": "InsuranceAgency",
    "name": "Rainbow Insurance Agency - American Access Casualty Insurance Authorized Agent",
    "description": "Get affordable American Access Casualty Insurance quotes in Fort Worth. Rainbow Insurance Agency specializes in American Access auto insurance & 56 carriers.",
    "url": "https://rainbowinsuranceoffice.com/american-access-casualty-insurance",
  ...
  const seoContent = `
    <div className="space-y-12">
      <section>
        <h2 className="text-3xl font-black text-gray-900 mb-6 text-center">American Access Casualty Insurance in Fort Worth: Accessible Auto Protection for Everyone</h2>
        <p className="text-lg text-gray-600 leading-relaxed mb-6">
          American Access Casualty Insurance (AAC) is a leading provider of non-standard auto insurance, dedicated to providing accessible and affordable coverage for drivers who may face challenges with traditional carriers. In the busy streets of Fort Worth, from the cultural district to the residential neighborhoods of Tarrant County, having reliable auto protection is a must. At Rainbow Insurance Agency, we are proud to be an authorized agent for American Access, bringing their specialized solutions to our neighbors. Whether you're a first-time driver, have a less-than-perfect driving record, or simply need a budget-friendly option to stay legal on Texas roads, American Access offers the flexibility and value you need. Susan and her expert team have been serving the Fort Worth community since 1993, and we know how to find the best American Access policy for your unique situation.
        </p>
        <p className="text-lg text-gray-600 leading-relaxed">
          The DFW metroplex is known for its heavy traffic and complex highway systems, including I-35W and I-30. In this environment, the risk of accidents is a daily reality. American Access focuses on the essentials, providing robust liability coverage that meets or exceeds Texas state requirements. This ensures that if you're involved in an accident, your financial assets are protected. At Rainbow Insurance Agency, we take the time to explain the details of your American Access policy, ensuring you understand exactly what your coverage includes. By shopping 56 carriers, including American Access, we ensure you're getting the most competitive rates available in the market.
        </p>
      </section>
      ...
      <section className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100">
        ...
        <p className="text-lg text-gray-600 leading-relaxed mb-6">
          One of the primary strengths of American Access is its commitment to the non-standard insurance market. They understand that every driver's history is unique, and they specialize in assessing risks that other carriers might avoid. This includes drivers with previous accidents, violations, or lapses in coverage. Susan and her expert team at Rainbow Insurance are masters at working with American Access to secure coverage for our clients who need it most. We believe that everyone deserves the opportunity to be insured and to drive with confidence.
        </p>
        <p className="text-lg text-gray-600 leading-relaxed">
          Our local expertise in Fort Worth allows us to provide personalized advice that you won't get from a generic call center. We understand the specific needs of North Texas drivers and can help you navigate American Access's offerings to find the perfect balance of price and protection. Whether you're a first-time driver or have years of experience, we're here to advocate for you and ensure you have the best possible insurance experience. This commitment to our clients' best interests is why Rainbow Insurance has been a trusted name in Tarrant County for over three decades.
        </p>
      </section>
      ...
      <section className="bg-slate-900 text-white rounded-3xl p-8 shadow-xl">
        ...
        <p className="text-lg text-white/80 leading-relaxed mb-6">
          The true value of an insurance policy is revealed when you have a claim. American Access is committed to providing efficient and fair claims handling, ensuring you get the support you need during a difficult time. They offer a streamlined claims process, with dedicated adjusters who work to resolve your case as quickly as possible. At Rainbow Insurance Agency, we're here to advocate for you throughout the entire claims experience. We can help you file the initial report, gather documentation, and communicate with the American Access claims team. Our goal is to ensure your claim is handled with integrity and speed.
        </p>
        <p className="text-lg text-white/80 leading-relaxed">
          We also provide ongoing support to our American Access policyholders. As your life changes, we're here to ensure your insurance keeps pace. Whether you're buying a new car, moving to a different part of Tarrant County, or simply have questions about your coverage, Susan and her expert team are just a phone call away. We believe in building long-term relationships with our clients, providing the expert guidance and personal service that you won't find at a national call center.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="text-lg text-gray-600 leading-relaxed mb-6">
          Choosing American Access Insurance through Rainbow Insurance Agency means you're getting more than just a policy; you're getting a partner in your protection. We've been a part of the Fort Worth community since 1993, and we understand the local market better than anyone. We know the specific risks of driving in North Texas, from the potential for hail damage to the challenges of navigating construction zones. This local knowledge allows us to provide more accurate advice and to tailor your American Access policy to your specific needs.
        </p>
        <p className="text-lg text-gray-600 leading-relaxed">
          Our independence is your greatest asset. While we are proud to represent American Access, we also shop 56 other A+ rated carriers. This means we can compare American Access's rates and coverage with the entire market to ensure you're getting the absolute best deal. If American Access is the best fit for you today, but your needs change tomorrow, we have the flexibility to move you to another carrier without any interruption in your protection. We work for YOU, not the insurance company.
        </p>
      </section>

      <section className="bg-rainbow-pink/5 rounded-3xl p-8 border border-rainbow-pink/10">
        <h3 className="text-2xl font-black text-gray-900 mb-6">Get Your American Access Quote Today: Start Saving in Fort Worth</h3>
        <p className="text-lg text-gray-600 leading-relaxed mb-6">
          Don't wait until you're in an accident to find out if you have the right protection at the right price. Call Rainbow Insurance Agency today at 817-922-8031 and let Susan and her expert team find you the best American Access Casualty Insurance rates in Fort Worth. We'll take the time to listen to your needs, answer your questions, and provide a free, no-obligation quote. Experience the Rainbow difference and see why thousands of your neighbors trust us with their auto insurance.
        </p>
        <p className="text-lg text-gray-600 leading-relaxed">
  ...
  return (
    <div className="bg-slate-50">
      <SEO 
        title="American Access Insurance Fort Worth | Authorized Agent | Best Rates"
        description="Get the best American Access Casualty Insurance rates in Fort Worth with Rainbow Insurance Agency. We shop 56 carriers to find you the absolute lowest rates."
        schema={carrierSchema}
        canonical="https://rainbowinsuranceoffice.com/american-access-casualty-insurance"
      />
      ...
      <section className="relative h-[600px] flex items-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img 
            src="https://images.unsplash.com/photo-1517677208171-0bc6725a3e60?w=1600&h=900&fit=crop" 
            alt="American Access Auto Insurance" 
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 w-full">
          ...
          >
            ...
            >
              ...
              <span>Authorized American Access Agent</span>
            </motion.div>
            ...
            <p className="text-2xl md:text-3xl mb-12 opacity-95 leading-relaxed drop-shadow-lg font-medium max-w-2xl">Get the best American Access Casualty Insurance rates and service in Fort Worth. Susan and her expert team shop 56 A+ rated carriers to find you the absolute lowest rates.</p>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                  {[
                    ...
                    { title: "American Access Pros", desc: "Accessible protection for you.", icon: ShieldCheck }
                  ].map((item, i) => (
              ...
              <div className="relative group">
                ...
                <div className="bg-white/5 backdrop-blur-md p-12 rounded-[3rem] border border-white/10 relative z-10">
                  ...
                  <p className="text-3xl text-white italic font-medium mb-10 leading-relaxed">
                    "American Access through Rainbow was the perfect solution for me. Susan and her expert team were so helpful and the rates were unbeatable!"
                  </p>
                  <div className="flex items-center gap-6">
                    ...
                    <div>
                      <div className="text-2xl font-black text-white">Ricardo M.</div>
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10 text-center">
          ...
          >
            ...
            <h2 className="text-5xl md:text-8xl font-black mb-10 leading-none tracking-tight">
              ...
              <span className="text-rainbow-gold">American Access Today</span>
            </h2>
