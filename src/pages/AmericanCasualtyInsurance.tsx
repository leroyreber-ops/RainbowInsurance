...
export default function AmericanCasualtyInsurance({ navigateTo, openQuoteForm }: PageProps) {
  const carrierSchema = {
    "@context": "https://schema.org",
    "@type": "InsuranceAgency",
    "name": "Rainbow Insurance Agency - American Casualty Insurance Authorized Agent",
    "description": "Get affordable American Casualty Insurance quotes in Fort Worth. Rainbow Insurance Agency specializes in American Casualty auto insurance & 56 carriers.",
    "url": "https://rainbowinsuranceoffice.com/american-casualty-insurance",
  ...
  const seoContent = `
    <div className="space-y-12">
      <section>
        <h2 className="text-3xl font-black text-gray-900 mb-6 text-center">American Casualty Insurance in Fort Worth: Robust Protection for Your Peace of Mind</h2>
        <p className="text-lg text-gray-600 leading-relaxed mb-6">
          American Casualty Insurance is a respected name in the insurance industry, known for its commitment to providing robust and reliable protection for individuals and families. In the dynamic city of Fort Worth, where the community's needs are as diverse as its landscape, American Casualty offers a range of insurance solutions designed to safeguard what matters most. At Rainbow Insurance Agency, we are proud to be an authorized agent for American Casualty, bringing their high-quality products to our neighbors in Tarrant County. Whether you're looking for comprehensive auto coverage or specialized liability protection, American Casualty provides the security and peace of mind that North Texas residents deserve. Susan and her expert team have been serving this community since 1993, and we understand how to leverage American Casualty's offerings to find the perfect fit for your needs.
        </p>
        <p className="text-lg text-gray-600 leading-relaxed">
          The DFW metroplex presents unique challenges for drivers and property owners alike, with busy highways and a rapidly growing population. American Casualty focuses on providing comprehensive coverage that meets or exceeds Texas state requirements, ensuring you're protected against financial loss in the event of an accident or unforeseen event. At Rainbow Insurance Agency, we take the time to explain the nuances of American Casualty's policies, helping you understand exactly what your coverage includes. We believe in transparency and personalized service, ensuring that every client feels confident in their protection. By shopping 56 carriers, including American Casualty, we ensure you're getting the most competitive rates available in the market.
        </p>
      </section>

      <section className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100">
        <h3 className="text-2xl font-black text-gray-900 mb-6">Tailored Solutions for Your Unique Lifestyle</h3>
        <p className="text-lg text-gray-600 leading-relaxed mb-6">
          One of the primary strengths of American Casualty is its ability to provide tailored insurance solutions that fit your unique lifestyle and budget. They understand that every client's situation is different, and they offer a variety of coverage options and endorsements that allow you to customize your policy. Susan and her expert team at Rainbow Insurance are masters at working with American Casualty to secure the protection our clients need. We believe that everyone deserves high-quality insurance that is specifically designed for their needs.
        </p>
        <p className="text-lg text-gray-600 leading-relaxed">
          Our local expertise in Fort Worth allows us to provide personalized advice that you won't get from a generic call center. We understand the specific risks of North Texas and can help you navigate American Casualty's offerings to find the perfect balance of price and protection. Whether you're a first-time driver or have years of experience, we're here to advocate for you and ensure you have the best possible insurance experience. This commitment to our clients' best interests is why Rainbow Insurance has been a trusted name in Tarrant County for over three decades.
        </p>
      </section>

      <section>
        <h3 className="text-2xl font-black text-gray-900 mb-6">Financial Strength and Reliability</h3>
        <p className="text-lg text-gray-600 leading-relaxed mb-6">
          When choosing an insurance carrier, financial strength and reliability are paramount. American Casualty has a strong track record of financial stability, ensuring they have the resources to handle claims efficiently and fairly. This provides you with long-term peace of mind, knowing that your protection is backed by a solid and dependable company. At Rainbow Insurance Agency, we only represent carriers that meet our high standards for financial integrity, and American Casualty is a prime example of this commitment.
        </p>
        <p className="text-lg text-gray-600 leading-relaxed">
          In addition to their financial strength, American Casualty is also known for its excellent customer service and claims support. They offer a streamlined claims process designed to resolve your case as quickly as possible, minimizing the disruption to your life. Susan and her expert team will support you throughout the entire claims experience, ensuring your interests are always protected. This dedication to service is a core value at Rainbow Insurance and is why we've been able to help thousands of Fort Worth residents with their insurance needs.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="text-lg text-gray-600 leading-relaxed mb-6">
          Choosing American Casualty Insurance through Rainbow Insurance Agency means you're getting more than just a policy; you're getting a partner in your protection. We've been a part of the Fort Worth community since 1993, and we understand the local market better than anyone. We know the specific risks of driving and owning property in North Texas, from the potential for hail damage to the challenges of navigating construction zones. This local knowledge allows us to provide more accurate advice and to tailor your American Casualty policy to your specific needs.
        </p>
        <p className="text-lg text-gray-600 leading-relaxed">
          Our independence is your greatest asset. While we are proud to represent American Casualty, we also shop 56 other A+ rated carriers. This means we can compare American Casualty's rates and coverage with the entire market to ensure you're getting the absolute best deal. If American Casualty is the best fit for you today, but your needs change tomorrow, we have the flexibility to move you to another carrier without any interruption in your protection. We work for YOU, not the insurance company.
        </p>
      </section>

      <section className="bg-rainbow-pink/5 rounded-3xl p-8 border border-rainbow-pink/10">
        <h3 className="text-2xl font-black text-gray-900 mb-6">Get Your American Casualty Quote Today: Start Saving in Fort Worth</h3>
        <p className="text-lg text-gray-600 leading-relaxed mb-6">
          Don't wait until you're in an accident to find out if you have the right protection at the right price. Call Rainbow Insurance Agency today at 817-922-8031 and let Susan and her expert team find you the best American Casualty Insurance rates in Fort Worth. We'll take the time to listen to your needs, answer your questions, and provide a free, no-obligation quote. Experience the Rainbow difference and see why thousands of your neighbors trust us with their insurance.
        </p>
        <p className="text-lg text-gray-600 leading-relaxed">
  ...
  return (
    <div className="bg-slate-50">
      <SEO 
        title="American Casualty Insurance Fort Worth | Authorized Agent | Best Rates"
        description="Get the best American Casualty Insurance rates in Fort Worth with Rainbow Insurance Agency. We shop 56 carriers to find you the absolute lowest rates."
        schema={carrierSchema}
        canonical="https://rainbowinsuranceoffice.com/american-casualty-insurance"
      />
      ...
      <section className="relative h-[600px] flex items-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img 
            ...
            alt="American Casualty Auto Insurance" 
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 w-full">
          ...
          >
            ...
            >
              ...
              <span>Authorized American Casualty Agent</span>
            </motion.div>
            ...
            <p className="text-2xl md:text-3xl mb-12 opacity-95 leading-relaxed drop-shadow-lg font-medium max-w-2xl">Get the best American Casualty Insurance rates and service in Fort Worth. Susan and her expert team shop 56 A+ rated carriers to find you the absolute lowest rates.</p>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                  {[
                    ...
                    { title: "American Casualty Pros", desc: "Robust protection for you.", icon: ShieldCheck }
                  ].map((item, i) => (
              ...
              <div className="relative group">
                ...
                <div className="bg-white/5 backdrop-blur-md p-12 rounded-[3rem] border border-white/10 relative z-10">
                  ...
                  <p className="text-3xl text-white italic font-medium mb-10 leading-relaxed">
                    "American Casualty through Rainbow was a great choice. Susan and her expert team were so helpful and the coverage is exactly what I needed. Highly recommend!"
                  </p>
                  <div className="flex items-center gap-6">
                    ...
                    <div>
                      <div className="text-2xl font-black text-white">Sarah L.</div>
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10 text-center">
          ...
          >
            ...
            <h2 className="text-5xl md:text-8xl font-black mb-10 leading-none tracking-tight">
              ...
              <span className="text-rainbow-gold">American Casualty Today</span>
            </h2>
