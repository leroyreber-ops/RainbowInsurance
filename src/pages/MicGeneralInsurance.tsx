...
export default function MicGeneralInsurance({ navigateTo, openQuoteForm }: PageProps) {
  const carrierSchema = {
    "@context": "https://schema.org",
    "@type": "InsuranceAgency",
    "name": "Rainbow Insurance Agency - MIC General Authorized Agent",
    "description": "Get affordable MIC General insurance quotes in Fort Worth. Rainbow Insurance Agency specializes in MIC General insurance & 56+ carriers.",
    "url": "https://rainbowinsuranceoffice.com/mic-general-insurance",
  ...
  return (
    <div className="bg-white">
      <SEO 
        title="MIC General Insurance Fort Worth | Authorized Agent | Best Rates"
        description="Get affordable MIC General insurance quotes in Fort Worth. Rainbow Insurance Agency shops MIC General & 56+ carriers to find the best rates. Call Susan & team!"
        schema={carrierSchema}
        canonical="https://rainbowinsuranceoffice.com/mic-general-insurance"
      />
      ...
      <section className="relative h-[650px] flex items-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img 
            ...
            alt="MIC General Insurance Protection" 
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 w-full">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-rainbow-gold/90 text-white px-4 py-1 rounded-full text-sm font-bold mb-6 shadow-lg">
              ...
              <span>Authorized MIC General Agent</span>
            </div>
            <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight drop-shadow-lg">
              MIC General <span className="text-rainbow-gold">Insurance</span> in Fort Worth
            </h1>
            <p className="text-xl md:text-2xl mb-8 opacity-95 leading-relaxed drop-shadow-md">
              Get the best MIC General Insurance rates and service in Fort Worth. Susan and her expert team shop 56+ A+ rated carriers to find you the absolute lowest rates and most comprehensive coverage.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-bold mb-8 text-gray-900 leading-tight">
              Reliable Protection with <span className="text-rainbow-pink">MIC General Insurance</span>
            </h2>
            <p className="text-xl text-gray-600 leading-relaxed">
              MIC General Insurance is a trusted provider known for high-quality protection and exceptional service. As an authorized agent in Fort Worth, Rainbow Insurance Agency makes the process simple, transparent, and affordable.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center mb-20">
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              <h3 className="text-3xl font-bold mb-8 text-gray-900">Why Choose MIC General with Rainbow?</h3>
              <div className="space-y-6 text-lg text-gray-600 leading-relaxed">
                <p>
                  When you choose MIC General through Rainbow Insurance, you're getting the combined expertise of Susan and her team. We know how to navigate MIC General's specialized rating system to find the absolute lowest rates for your specific needs.
                </p>
                <p>
          ...
          <ExpandableText maxLines={20}>
            <div className="space-y-12">
              <section>
                <h3 className="text-3xl font-bold mb-6 text-gray-900">Comprehensive MIC General Insurance Solutions in Fort Worth</h3>
                <p className="text-lg text-gray-600 leading-relaxed mb-6">
                  MIC General Insurance has established itself as a premier provider of property insurance solutions, known for its commitment to high-quality protection, innovative coverage options, and exceptional customer service. For residents of Fort Worth, Texas, navigating the complexities of insurance can be daunting, but with MIC General Insurance, you gain access to robust policies designed to safeguard your most valuable assets. At Rainbow Insurance Agency, we are proud to serve as your authorized MIC General agent, simplifying the insurance process and ensuring you receive the coverage you deserve at an affordable price.
                </p>
                <p className="text-lg text-gray-600 leading-relaxed mb-6">
                  Whether you are a homeowner, a renter, or a condo owner, MIC General offers tailored solutions that address the unique risks associated with living in Tarrant County. From severe weather events to unexpected property damage, MIC General's comprehensive policies provide the peace of mind you need to focus on what matters most. Our team at Rainbow Insurance Agency works tirelessly to ensure that your MIC General policy is not just a document, but a reliable safety net that stands ready when you need it most.
                </p>
              </section>

              <section>
                <h3 className="text-3xl font-bold mb-6 text-gray-900">Why Choose MIC General Insurance?</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100">
                    <h4 className="text-2xl font-bold mb-4 text-rainbow-pink">Innovative Coverage</h4>
                    <p className="text-gray-600">MIC General is at the forefront of insurance innovation, offering flexible coverage options that can be customized to fit your specific lifestyle and property needs. Their policies are designed to evolve with you, ensuring you never pay for coverage you don't need while maintaining protection where it matters most.</p>
                  </div>
                  <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100">
                    <h4 className="text-2xl font-bold mb-4 text-rainbow-pink">Financial Strength</h4>
                    <p className="text-gray-600">With a solid reputation for financial stability, MIC General Insurance provides the assurance that they have the resources to honor claims promptly and efficiently, even in the face of widespread disasters or significant property damage.</p>
                  </div>
                </div>
              </section>
              ...
              <section>
                ...
                <p className="text-lg text-gray-600 leading-relaxed mb-6">
                  Fort Worth homeowners face unique environmental challenges, including severe thunderstorms, hail, and occasional tornadoes. These weather patterns make robust property insurance not just a luxury, but a necessity. MIC General Insurance policies are designed to provide the specific protections needed to recover from these common Texas weather events. Our agents at Rainbow Insurance Agency can help you assess your property's vulnerability and ensure your policy includes adequate coverage for wind and hail damage.
                </p>
              </section>
              ...
              <section>
                ...
                <ul className="list-disc pl-6 space-y-4 text-lg text-gray-600 leading-relaxed">
                  <li><strong>Personalized Consultations:</strong> We take the time to understand your unique situation, ensuring your MIC General policy is perfectly tailored to your needs.</li>
              ...
              <section>
                ...
                <div className="space-y-6">
                  {[
                    { q: "Is MIC General Insurance good for Fort Worth homes?", a: "Yes, MIC General offers robust coverage tailored to the specific risks faced by Fort Worth homeowners, including severe weather protection." },
                    { q: "Can I bundle my auto insurance with MIC General?", a: "Absolutely. Bundling your policies through Rainbow Insurance Agency can lead to significant discounts." },
                    { q: "How do I file a claim with MIC General?", a: "MIC General offers 24/7 claims support. Our team at Rainbow Insurance Agency can also assist you in initiating and managing your claim." }
                  ].map((faq, i) => (
      ...
      <section className="py-24 bg-rainbow-pink text-white text-center">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <p className="text-2xl mb-16 opacity-90">
            Call Rainbow Insurance Agency today at 817-922-8031 and let Susan and her expert team find you the best MIC General Insurance rates in Fort Worth.
          </p>
          <button 
            onClick={openQuoteForm}
