...
export default function OldAmericanInsurance({ navigateTo, openQuoteForm }: PageProps) {
  const carrierSchema = {
    "@context": "https://schema.org",
    "@type": "InsuranceAgency",
    "name": "Rainbow Insurance Agency - Old American Authorized Agent",
    "description": "Get cheap Old American insurance quotes in Fort Worth. Rainbow Insurance Agency shops Old American & 56+ carriers to find the best rates. SR-22 specialists.",
    "url": "https://rainbowinsuranceoffice.com/old-american-insurance",
  ...
  const contentBlocks = [
    {
      title: "Old American Insurance in Fort Worth: Texas-Sized Protection",
      content: `Old American County Mutual Fire Insurance Company is a Texas-based insurer that has been serving the needs of Texas drivers for decades. As an authorized Old American agent in Fort Worth, Rainbow Insurance Agency is proud to offer our clients access to their specialized and affordable products, including non-standard auto insurance.

When you choose Old American through Rainbow Insurance, you're getting the combined expertise of Susan and her expert team. We understand how to navigate Old American's unique underwriting guidelines to find the absolute lowest rates for your specific needs. Old American is particularly strong in the non-standard auto market, often offering the best value for clients with diverse needs in the DFW metroplex.

Our team doesn't just stop at one quote. We compare Old American's offerings with our 56+ other A+ rated carriers to ensure you're getting the absolute best deal available in Tarrant County. We believe in providing the best service and the best rates, and Old American is a key partner in helping us achieve that for our clients.`
    },
    {
      title: "The Advantages of Old American Insurance with Rainbow Insurance Agency",
      content: `Working with an independent agent like Rainbow Insurance Agency to secure your Old American policy offers several key advantages. First is our local expertise. We know the Fort Worth and Dallas areas, and we understand the unique risks and requirements of Texas drivers. We can provide personalized advice that you won't get from a generic call center.

Old American is known for its commitment to providing "Insurance for the Way You Live," focusing on comprehensive coverage and competitive pricing. They understand that everyone's situation is unique, and they work to provide coverage that fits your life and budget. This shared commitment to personal service and flexibility makes Old American a natural fit for our clients.

Furthermore, Old American offers a variety of specialized features that we can help you unlock. From fast and efficient SR-22 filings to flexible payment plans, we'll make sure you're taking full advantage of every opportunity to secure the protection you need. We've been serving the North Texas community since 1993, and our reputation for integrity and honesty is built on finding the best solutions for our clients.`
    },
    {
      title: "Old American Non-Standard Auto Insurance Features",
      content: `Old American specializes in providing comprehensive insurance coverage for vehicles, particularly for those in the non-standard market. Some of the key features of their policies include:

• SR-22 Filings: Fast and efficient SR-22 filings for drivers who need to prove financial responsibility to the state.
• Flexible Underwriting: Coverage options for drivers with diverse needs and driving histories.
• Competitive Pricing: Affordable rates designed to fit your budget.
• Flexible Payment Options: A variety of payment plans designed to fit your budget.
• 24/7 Claims Service: Old American is committed to handling claims quickly and fairly, ensuring you get back on the road or back to your life as soon as possible.

At Rainbow Insurance Agency, we'll help you understand these features and ensure you have the right level of protection for your needs. We're dedicated to providing the best service and the best rates in the business, and Old American's reliable products are a big part of that.`
    },
    {
      title: "Serving the Entire DFW Metroplex with Old American Insurance",
      content: `Whether you're driving in the heart of Fort Worth, commuting to Dallas, or living in one of the many vibrant communities in Arlington or Garland, Old American Insurance and Rainbow Insurance Agency have you covered. We serve the entire DFW metroplex, providing expert advice and the best insurance rates to thousands of satisfied clients.

Our team is particularly skilled at helping clients who need high-quality protection for their vehicles, even if they have a challenging driving history. Old American's competitive pricing and flexible underwriting often make them the best choice for those looking for reliable protection at a price they can afford. We believe that everyone deserves the best protection at a price they can afford.

Believe in us for your Old American insurance needs. Susan and her expert team have the experience, the carriers, and the dedication to ensure you're always getting the best value. Experience the Rainbow difference today and see why we're the top choice for insurance in Fort Worth and beyond.`
    }
  ];
  ...
  return (
    <div className="bg-slate-50">
      <SEO 
        title="Old American Insurance Fort Worth | Authorized Agent | Best Rates"
        description="Get cheap Old American insurance quotes in Fort Worth. Rainbow Insurance Agency shops Old American & 56+ carriers to find the best rates. SR-22 specialists. Call Susan & team today!"
      ...
      <section className="relative h-[600px] flex items-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img 
            ...
            alt="Old American Insurance Protection" 
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 w-full">
          ...
          >
            ...
            >
              ...
              <span>Authorized Old American Agent</span>
            </motion.div>
            ...
            <p className="text-2xl md:text-3xl mb-12 opacity-95 leading-relaxed drop-shadow-lg font-medium max-w-2xl">Get the best Old American Insurance rates and service in Fort Worth. Susan and her expert team shop 56 A+ rated carriers to find you the absolute lowest rates and most comprehensive coverage.</p>
                ...
                >
                  <div className="lg:w-1/2">
                    <div className={`inline-flex items-center gap-3 px-6 py-2 rounded-full text-sm font-black mb-8 shadow-sm border ${
                      ...
                      <span>Expert Old American Advice</span>
                    </div>
              ...
              <div className="relative group">
                ...
                <div className="bg-white/5 backdrop-blur-md p-12 rounded-[3rem] border border-white/10 relative z-10">
                  ...
                  <p className="text-3xl text-white italic font-medium mb-10 leading-relaxed">
                    "Old American through Rainbow was the best decision for my car insurance. Susan and her expert team were so helpful and the rates were unbeatable!"
                  </p>
                  <div className="flex items-center gap-6">
                    <div className="w-16 h-16 bg-rainbow-gold rounded-2xl flex items-center justify-center text-white text-2xl font-black shadow-xl">O</div>
                    <div>
                      <div className="text-2xl font-black text-white">Oscar R.</div>
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10 text-center">
          ...
          >
            ...
            <h2 className="text-5xl md:text-8xl font-black mb-10 leading-none tracking-tight">
              ...
              <span className="text-rainbow-gold">Old American Today</span>
            </h2>
