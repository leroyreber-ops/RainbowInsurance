...
export default function AssuranceAmericaInsurance({ navigateTo, openQuoteForm }: PageProps) {
  const carrierSchema = {
    "@context": "https://schema.org",
    "@type": "InsuranceAgency",
    "name": "Rainbow Insurance Agency - AssuranceAmerica Insurance Authorized Agent",
    "description": "Get affordable AssuranceAmerica Insurance quotes in Fort Worth. Rainbow Insurance Agency specializes in AssuranceAmerica auto insurance & 56 carriers.",
    "url": "https://rainbowinsuranceoffice.com/assuranceamerica-insurance",
  ...
  const seoContent = `
    <div className="space-y-12">
      <section>
        <h2 className="text-3xl font-black text-gray-900 mb-6 text-center">AssuranceAmerica Insurance in Fort Worth: Accessible Auto Coverage for Every Driver</h2>
        <p className="text-lg text-gray-600 leading-relaxed mb-6">
          AssuranceAmerica Insurance is a leading provider of non-standard auto insurance, dedicated to providing accessible and affordable coverage for drivers who may face challenges with traditional carriers. In the busy streets of Fort Worth, from the cultural district to the residential neighborhoods of Tarrant County, having reliable auto protection is a must. At Rainbow Insurance Agency, we are proud to be an authorized agent for AssuranceAmerica, bringing their specialized solutions to our neighbors. Whether you're a first-time driver, have a less-than-perfect driving record, or simply need a budget-friendly option to stay legal on Texas roads, AssuranceAmerica offers the flexibility and value you need. Susan and her expert team have been serving the Fort Worth community since 1993, and we know how to find the best AssuranceAmerica policy for your unique situation.
        </p>
        <p className="text-lg text-gray-600 leading-relaxed">
          The DFW metroplex is known for its heavy traffic and complex highway systems, including I-35W and I-30. In this environment, the risk of accidents is a daily reality. AssuranceAmerica focuses on the essentials, providing robust liability coverage that meets or exceeds Texas state requirements. This ensures that if you're involved in an accident, your financial assets are protected. At Rainbow Insurance Agency, we take the time to explain the details of your AssuranceAmerica policy, ensuring you understand exactly what your coverage includes. By shopping 56 carriers, including AssuranceAmerica, we ensure you're getting the most competitive rates available in the market.
        </p>
      </section>
      ...
      <section className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100">
        ...
        <p className="text-lg text-gray-600 leading-relaxed mb-6">
          One of the primary strengths of AssuranceAmerica is its commitment to the non-standard insurance market. They understand that every driver's history is unique, and they specialize in assessing risks that other carriers might avoid. This includes drivers with previous accidents, violations, or lapses in coverage. Susan and her expert team at Rainbow Insurance are masters at working with AssuranceAmerica to secure coverage for our clients who need it most. We believe that everyone deserves the opportunity to be insured and to drive with confidence.
        </p>
        <p className="text-lg text-gray-600 leading-relaxed">
          Our local expertise in Fort Worth allows us to provide personalized advice that you won't get from a generic call center. We understand the specific needs of North Texas drivers and can help you navigate AssuranceAmerica's offerings to find the perfect balance of price and protection. Whether you're a first-time driver or have years of experience, we're here to advocate for you and ensure you have the best possible insurance experience. This commitment to our clients' best interests is why Rainbow Insurance has been a trusted name in Tarrant County for over three decades.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="text-lg text-gray-600 leading-relaxed mb-6">
          Managing a monthly budget in Fort Worth is a top priority for many families. AssuranceAmerica recognizes this and offers a variety of flexible payment plans designed to fit your financial situation. Whether you prefer to pay in full or need to spread your payments out, AssuranceAmerica has an option that works for you. At Rainbow Insurance Agency, we'll help you explore these payment structures and find the one that best aligns with your cash flow. We believe that high-quality insurance should be accessible to everyone, and flexible payments are a key part of that accessibility.
        </p>
        <p className="text-lg text-gray-600 leading-relaxed">
          In addition to flexible payments, AssuranceAmerica also offers a range of discounts that can further lower your premiums. From multi-car discounts to savings for safe driving and vehicle safety features, there are many ways to save. Susan and her expert team will conduct a thorough review of your situation to ensure you're receiving every possible cent of savings. We're proactive in our approach, always looking for ways to put more money back in your pocket while keeping you fully protected.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="text-lg text-gray-600 leading-relaxed mb-6">
          Choosing AssuranceAmerica Insurance through Rainbow Insurance Agency means you're getting more than just a policy; you're getting a partner in your protection. We've been a part of the Fort Worth community since 1993, and we understand the local market better than anyone. We know the specific risks of driving in North Texas, from the potential for hail damage to the challenges of navigating construction zones. This local knowledge allows us to provide more accurate advice and to tailor your AssuranceAmerica policy to your specific needs.
        </p>
        <p className="text-lg text-gray-600 leading-relaxed">
          Our independence is your greatest asset. While we are proud to represent AssuranceAmerica, we also shop 56 other A+ rated carriers. This means we can compare AssuranceAmerica's rates and coverage with the entire market to ensure you're getting the absolute best deal. If AssuranceAmerica is the best fit for you today, but your needs change tomorrow, we have the flexibility to move you to another carrier without any interruption in your protection. We work for YOU, not the insurance company.
        </p>
      </section>

      <section className="bg-rainbow-pink/5 rounded-3xl p-8 border border-rainbow-pink/10">
        <h3 className="text-2xl font-black text-gray-900 mb-6">Get Your AssuranceAmerica Quote Today: Start Saving in Fort Worth</h3>
        <p className="text-lg text-gray-600 leading-relaxed mb-6">
          Don't wait until you're in an accident to find out if you have the right protection at the right price. Call Rainbow Insurance Agency today at 817-922-8031 and let Susan and her expert team find you the best AssuranceAmerica Insurance rates in Fort Worth. We'll take the time to listen to your needs, answer your questions, and provide a free, no-obligation quote. Experience the Rainbow difference and see why thousands of your neighbors trust us with their auto insurance.
        </p>
        <p className="text-lg text-gray-600 leading-relaxed">
  ...
  return (
    <div className="bg-slate-50">
      <SEO 
        title="AssuranceAmerica Insurance Fort Worth | Authorized Agent | Best Rates"
        description="Get the best AssuranceAmerica Insurance rates in Fort Worth with Rainbow Insurance Agency. We shop 56 carriers to find you the absolute lowest rates."
        schema={carrierSchema}
        canonical="https://rainbowinsuranceoffice.com/assuranceamerica-insurance"
      />
      ...
      <section className="relative h-[600px] flex items-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img 
            src="https://images.unsplash.com/photo-1533473359331-0135ef1b58bf?w=1600&h=900&fit=crop" 
            alt="AssuranceAmerica Auto Insurance" 
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 w-full">
          ...
          >
            ...
            >
              ...
              <span>Authorized AssuranceAmerica Agent</span>
            </motion.div>
            ...
            <p className="text-2xl md:text-3xl mb-12 opacity-95 leading-relaxed drop-shadow-lg font-medium max-w-2xl">Get the best AssuranceAmerica Insurance rates and service in Fort Worth. Susan and her expert team shop 56 A+ rated carriers to find you the absolute lowest rates.</p>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                  {[
                    ...
                    { title: "AssuranceAmerica Pros", desc: "Accessible protection for you.", icon: ShieldCheck }
                  ].map((item, i) => (
              ...
              <div className="relative group">
                ...
                <div className="bg-white/5 backdrop-blur-md p-12 rounded-[3rem] border border-white/10 relative z-10">
                  ...
                  <p className="text-3xl text-white italic font-medium mb-10 leading-relaxed">
                    "AssuranceAmerica through Rainbow was the perfect solution for me. Susan and her expert team were so helpful and the rates were unbeatable!"
                  </p>
                  <div className="flex items-center gap-6">
                    ...
                    <div>
                      <div className="text-2xl font-black text-white">Jose G.</div>
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10 text-center">
          ...
          >
            ...
            <h2 className="text-5xl md:text-8xl font-black mb-10 leading-none tracking-tight">
              ...
              <span className="text-rainbow-gold">AssuranceAmerica Today</span>
            </h2>
