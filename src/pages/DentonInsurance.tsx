...
export default function DentonInsurance({ navigateTo, openQuoteForm }: PageProps) {
  const dentonSchema = {
    "@context": "https://schema.org",
    "@type": "InsuranceAgency",
    "name": "Rainbow Insurance Agency - Denton",
    "description": "Cheap car insurance and SR-22 specialists in Denton, TX. We shop 56+ carriers to find the best rates for Denton drivers.",
    "url": "https://rainbowinsuranceoffice.com/denton-insurance",
  ...
  const contentBlocks = [
    {
      title: "Affordable Auto Insurance in Denton, TX",
      content: `Denton is a city that marches to its own beat, known for its vibrant music scene, two major universities (UNT and TWU), and a historic downtown square that is the heart of the community. From the lively streets of Fry Street to the quiet residential neighborhoods, Denton drivers need insurance that is both reliable and affordable. At Rainbow Insurance Agency, we specialize in finding the absolute lowest rates on car insurance for Denton residents.

Whether you're a student at UNT or TWU, a professional working in the growing tech sector, or a family living in South Denton, we ensure you're protected. Susan and her expert team are experts at shopping over 56 A+ rated carriers to find the policy that fits your specific needs. We understand that Denton residents value both independence and savings, and we deliver both.

Finding "cheap car insurance" in Denton doesn't mean you have to sacrifice quality. As independent agents, we have access to a wide range of companies that many direct-to-consumer insurers can't match. We look for every possible discount, from student savings to multi-policy rewards, ensuring that you get the most comprehensive coverage at the best possible price.`
    },
    {
      title: "Denton SR-22 and High-Risk Insurance Experts",
      content: `If you've had a few driving infractions in Denton, such as tickets, accidents, or a requirement for an SR-22 filing, Rainbow Insurance Agency is here to help. We are the premier SR-22 specialists in the Denton area, providing expert guidance and affordable options for high-risk drivers.

An SR-22 is a certificate of financial responsibility required by the state of Texas. Many standard insurance companies will shy away from drivers who need an SR-22, but we embrace the challenge. Because we represent 56+ carriers, we know exactly which ones offer the best rates for SR-22 filings in Denton.

Susan and her expert team provide a supportive and professional environment to help you navigate the SR-22 process. We handle all the paperwork and ensure your filing is processed correctly with the Texas DPS. We believe that everyone in Denton deserves a second chance and the ability to drive safely and legally.`
    },
    {
      title: "Comprehensive Protection for Denton Homes and Businesses",
      content: `Denton is a city of beautiful neighborhoods and thriving businesses. At Rainbow Insurance Agency, we offer a full range of insurance products tailored to the needs of Denton residents and business owners. Our Homeowners Insurance policies provide robust protection against the unpredictable Texas weather, ensuring your home is covered from roof to foundation.

For Denton's thriving business community, we offer specialized Commercial Insurance solutions. Whether you're a small business in the historic downtown or a growing company in the industrial district, we can protect your business from liability, property damage, and more. Our commercial lines include general liability, workers' compensation, and commercial auto insurance, all backed by our commitment to "Best Rates, Best Service."

We also offer Renters Insurance for those living in Denton's many vibrant apartment communities, as well as specialized coverage for motorcycles, RVs, and boats. Whatever you need to protect in Denton, Rainbow Insurance has the expertise and the carrier network to find you the perfect policy.`
    },
    {
      title: "The Rainbow Insurance Advantage in Denton",
      content: `Why choose Rainbow Insurance Agency for your Denton insurance needs? It's our combination of local expertise and massive shopping power. When you call us, you're not just a number; you're a neighbor. You'll speak with Susan and her expert team—experts who are dedicated to finding you the best value.

We are proud to serve all of Denton, including:
• Historic Downtown Denton Square
• UNT & TWU Campus Areas
• South Denton & Corinth border
• North Denton & Sanger border
• West Denton & Krum border
• All surrounding Denton County communities

Our independence is your greatest asset. We don't work for the insurance companies; we work for you. This means we are always on your side, looking for ways to save you money and improve your coverage. Believe in us for your Denton insurance needs, and experience the best rates and the best service in North Texas today.`
    }
  ];
  ...
  return (
    <div className="bg-slate-50">
      <SEO 
        title="Denton Car Insurance & SR-22 | Cheap Rates & Best Service"
        description="Looking for cheap car insurance in Denton, TX? Rainbow Insurance Agency shops 56+ carriers to find the best rates. SR-22 specialists. Call Susan & team today!"
        schema={dentonSchema}
        canonical="https://rainbowinsuranceoffice.com/denton-insurance"
      />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 w-full">
          ...
          >
            ...
            >
              ...
              <span>Serving the Entire Denton Area</span>
            </motion.div>
            ...
            <p className="text-2xl md:text-3xl mb-12 opacity-95 leading-relaxed drop-shadow-lg font-medium max-w-2xl">Get the best Cheap Denton Insurance rates and service in Fort Worth. Susan and her expert team shop 56 A+ rated carriers to find you the absolute lowest rates and most comprehensive coverage.</p>
              ...
              >
                <div className="lg:w-1/2">
                  <div className={`inline-flex items-center gap-3 px-6 py-2 rounded-full text-sm font-black mb-8 shadow-sm border ${
                    ...
                    <span>Expert Denton Insurance Advice</span>
                  </div>
            ...
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
              <div>
                <h2 className="text-5xl md:text-7xl font-black mb-10 leading-tight">
                  The Best Service <br />
                  <span className="text-rainbow-gold">In Denton</span>
                </h2>
                <p className="text-2xl text-white/70 mb-12 leading-relaxed font-medium">
                  We don't just sell insurance; we provide peace of mind. Our team is dedicated to finding you the best rates and providing the best service in Denton.
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                  {[
                    { title: "Local Experts", desc: "We know Denton traffic and risks.", icon: MapPin },
              ...
              <div className="relative group">
                ...
                <div className="bg-white/5 backdrop-blur-md p-12 rounded-[3rem] border border-white/10 relative z-10">
                  ...
                  <p className="text-3xl text-white italic font-medium mb-10 leading-relaxed">
                    "Susan and her expert team are the best! They saved me $800 a year on my Denton car insurance. I wouldn't go anywhere else."
                  </p>
                  <div className="flex items-center gap-6">
                    ...
                    <div>
                      <div className="text-2xl font-black text-white">John D.</div>
                      <div className="text-rainbow-gold font-bold">Denton Resident</div>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10 text-center">
          ...
          >
            ...
            <h2 className="text-5xl md:text-8xl font-black mb-10 leading-none tracking-tight">
              ...
              <span className="text-rainbow-gold">Denton Today</span>
            </h2>
            <p className="text-2xl md:text-3xl mb-16 opacity-90 max-w-4xl mx-auto leading-relaxed font-medium">
              Join thousands of Denton drivers who have found the best rates and best service with Rainbow Insurance.
            </p>
