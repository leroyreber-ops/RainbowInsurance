...
export default function GEICOInsurance({ navigateTo, openQuoteForm }: PageProps) {
  const carrierSchema = {
    "@context": "https://schema.org",
    "@type": "InsuranceAgency",
    "name": "Rainbow Insurance Agency - GEICO Authorized Agent",
    "description": "Get cheap GEICO insurance quotes in Fort Worth. Rainbow Insurance Agency shops GEICO & 56+ carriers to find the best rates. SR-22 specialists.",
    "url": "https://rainbowinsuranceoffice.com/geico-insurance",
...
Believe in us for your GEICO insurance needs. Susan and her expert team have the experience, the carriers, and the dedication to ensure you're always getting the best value. Experience the Rainbow difference today and see why we're the top choice for insurance in Fort Worth and beyond.`
  ...
  return (
    <div className="bg-slate-50">
      <SEO 
        title="GEICO Insurance Fort Worth | Authorized Agent | Best Rates"
        description="Get affordable GEICO insurance quotes in Fort Worth. Rainbow Insurance Agency shops GEICO & 56+ carriers to find the best rates. SR-22 specialists. Call Susan & team!"
        schema={carrierSchema}
        canonical="https://rainbowinsuranceoffice.com/geico-insurance"
      />
      ...
      <section className="relative h-[600px] flex items-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img 
            ...
            alt="GEICO Insurance Protection" 
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 w-full">
          ...
          >
            ...
            >
              ...
              <span>Authorized GEICO Agent</span>
            </motion.div>
            ...
            <p className="text-2xl md:text-3xl mb-12 opacity-95 leading-relaxed drop-shadow-lg font-medium max-w-2xl">Get the best GEICO Insurance rates and service in Fort Worth. Susan and her expert team shop 56 A+ rated carriers to find you the absolute lowest rates and most comprehensive coverage.</p>
              ...
              <div className="relative group">
                ...
                <div className="bg-white/5 backdrop-blur-md p-12 rounded-[3rem] border border-white/10 relative z-10">
                  ...
                  <p className="text-3xl text-white italic font-medium mb-10 leading-relaxed">
                    "GEICO through Rainbow was the best decision for my car insurance. Susan and her expert team were so helpful and the rates were unbeatable!"
                  </p>
                  <div className="flex items-center gap-6">
                    ...
                    <div>
                      <div className="text-2xl font-black text-white">Gary M.</div>
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10 text-center">
          ...
          >
            ...
            <h2 className="text-5xl md:text-8xl font-black mb-10 leading-none tracking-tight">
              ...
              <span className="text-rainbow-gold">GEICO Today</span>
            </h2>
