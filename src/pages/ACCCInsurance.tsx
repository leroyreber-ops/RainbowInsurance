...
export default function ACCCInsurance({ navigateTo, openQuoteForm }: PageProps) {
  const carrierSchema = {
    "@context": "https://schema.org",
    "@type": "InsuranceAgency",
    "name": "Rainbow Insurance Agency - ACCC Authorized Agent",
    "description": "Get the best ACCC Insurance rates in Fort Worth with Rainbow Insurance Agency. We shop 56 carriers to find you the absolute lowest rates on auto insurance.",
    "url": "https://rainbowinsuranceoffice.com/accc-insurance",
  ...
  return (
    <div className="bg-slate-50">
      <SEO 
        title="ACCC Insurance Fort Worth | Authorized Agent | Best Rates"
        description="Get the best ACCC Insurance rates in Fort Worth with Rainbow Insurance Agency. We shop 56 carriers to find you the absolute lowest rates on auto insurance."
        schema={carrierSchema}
        canonical="https://rainbowinsuranceoffice.com/accc-insurance"
      />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 w-full">
          ...
          >
            ...
            >
              ...
              <span>Authorized ACCC Agent</span>
            </motion.div>
            ...
            <p className="text-2xl md:text-3xl mb-12 opacity-95 leading-relaxed drop-shadow-lg font-medium max-w-2xl">Get the best ACCC Insurance rates and service in Fort Worth. Susan and her expert team shop 56 A+ rated carriers to find you the absolute lowest rates and most comprehensive coverage.</p>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                  {[
                    ...
                    { title: "ACCC Pros", desc: "Affordable protection for you.", icon: ShieldCheck }
                  ].map((item, i) => (
              ...
              <div className="relative group">
                ...
                <div className="bg-white/5 backdrop-blur-md p-12 rounded-[3rem] border border-white/10 relative z-10">
                  ...
                  <p className="text-3xl text-white italic font-medium mb-10 leading-relaxed">
                    "ACCC through Rainbow was the best decision for my car insurance. Susan and her expert team were so helpful and the rates were unbeatable!"
                  </p>
                  <div className="flex items-center gap-6">
                    ...
                    <div>
                      <div className="text-2xl font-black text-white">Arthur G.</div>
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10 text-center">
          ...
          >
            ...
            <h2 className="text-5xl md:text-8xl font-black mb-10 leading-none tracking-tight">
              ...
              <span className="text-rainbow-gold">ACCC Today</span>
            </h2>
